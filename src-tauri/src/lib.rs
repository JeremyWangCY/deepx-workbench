...
const TOOLBAR_SCRIPT: &str = r###"(() => {
  ...
  const css = ''
    ...
    + '.deepx-status{color:#5f6368!important;font-size:11px!important;line-height:1.5!important;margin-top:6px!important;min-height:18px!important}.deepx-error{color:#c23d3d!important}html{padding-top:40px!important;box-sizing:border-box!important}[class*="_overlay"]{top:40px!important;height:calc(100vh - 40px)!important;box-sizing:border-box!important;padding:24px 20px 20px!important}[class*="_panel"]{max-height:calc(100vh - 88px)!important}';
